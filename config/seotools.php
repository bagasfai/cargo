...
return [
    ...
    'opengraph' => [
        ...
        'defaults' => [
            'title'       => 'Kargo Tangerang (Insan Cargo Tangerang)', // set false to total remove
            'description' => 'Kargo Tangerang (Insan Cargo Tangerang) Melayani pengiriman barang hingga ekspedisi murah ke seluruh Indonesia.', // set false to total remove
            'url'         => null, // Set null for using Url::current(), set false to total remove
            'type'        => 'website',
            'site_name'   => 'Kargo Tangerang (Insan Cargo Tangerang)',
            'images'      => [],
        ],
    ],
    'twitter' => [
