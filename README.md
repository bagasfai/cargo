## 📋 Requirements
To set up the project, make sure your environment includes:

* **PHP 8.3+**
* **Composer** (PHP dependency manager)
* **Node.js 18+** and **npm** (for compiling frontend assets)
* **Database** - Works with MySQL(default), SQLite, or PostgreSQL
...
```bash
git clone https://github.com/bagasfai/cargo.git
cd cargo
```
