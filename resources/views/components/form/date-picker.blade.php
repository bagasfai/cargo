...
<div x-data="{
    ...
    clear() {
        ...
        // Ensure listeners (e.g., table filters) can react and update the URL
        this.$dispatch('date-change', {
            selectedDates: [],
            dateStr: '',
    ...
    <div class="relative custom-datepicker">
        <input x-ref="dateInput" type="text" id="{{ $id }}" name="{{ $name }}"
        ...
        <button type="button" x-show="hasValue" x-cloak @click="clear()"
            class="absolute right-10 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
            aria-label="Clear date" title="Clear">
            ×
        </button>
