...
@section('content')
    ...
    <div class="max-w-5xl mx-auto space-y-6" x-data="blogForm()">
        ...
        <div class="flex justify-between items-center">
            <x-ui.heading level="h1">Create Blog</x-ui.heading>
        ...
        <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <x-form.input name="title" label="Title" placeholder="Enter blog title" x-model="form.title" />

                    <x-form.input name="slug" label="Slug (SEO URL)" placeholder="auto-generated-from-title" />
                    ...
                    <x-form.textarea name="excerpt" label="Excerpt" placeholder="Short description" />
                </div>
