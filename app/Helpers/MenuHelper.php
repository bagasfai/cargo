...
class MenuHelper
{
    public static function getMainNavItems()
    {
        return [
            ...
            [
                'icon' => 'pricing',
                'name' => 'Expedition Prices',
                'path' => '/admin/expedition-prices'
            ],
            [
                'icon' => 'location',
                'name' => 'Locations',
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'blog' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            'pricing' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
